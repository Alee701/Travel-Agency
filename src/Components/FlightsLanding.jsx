...
function FlightsLanding() {
    return (
        <>
            <div id='FlightLanding' className='w-[40%] bg-black relative text-center text-white h-[550px] rounded-3xl'>
                ...
                <div className='absolute bottom-10 flex flex-col items-center justify-center w-full gap-2'>
                    ...
                    <h3 className='text-base p-4'>Search Flights & Places Hire to our most popular <br /> destinations</h3>
