    ...
    return (
        <form action="" onSubmit={handleSignupForm}>
            ...
            <div id='insideSignup' className='flex  gap-4 mt-4 w-full flex-wrap'>
                <fieldset className='w-[350px] h-[60px] relative flex items-center border px-5 rounded border-[#79747E]'>
                ...
                <fieldset className=' w-[98%] h-[60px] relative flex items-center border px-5 rounded border-[#79747E]'>
                ...
                <input type="submit" id='signupsubmit' value={loading ? 'Sign in...' : 'Create Account'} className='h-[50px] cursor-pointer rounded mt-8 w-[720px] bg-[#8DD3BB] font-semibold text-[#112211] text-[18px] ' />
            </div>
        </form> 
