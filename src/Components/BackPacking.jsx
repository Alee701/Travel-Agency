...
function BackPacking() {
  return (
    <div id='backpackingchild' className='w-[550px] h-[420px] text-[#112211] flex flex-col gap-[50px] p-6 rounded-[20px] bg-[#8DD3BB]'>
        <div className='flex flex-col gap-6 m-auto w-[100%]'>
        ...
        <button className='text-[14px] font-medium w-[100%] h-[50px]  rounded-lg bg-white m-auto'>Book Flight</button>
    </div>
  )
}
