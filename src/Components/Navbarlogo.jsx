...
import stay from "../assets/logo-icon/stay.png";
import LOGO from "../assets/logo-icon/white logo.png";
                ...
                <div id='NavbarChild' className='flex justify-between items-center w-[55%] '>
                    ...
                    <Link to={'/FlightFlow'}>
                        <div className='flex gap-1 font-semibold text-[14px]'>
                            <img src={airplane} className='h-[20px] ml-3' alt="" /><h3 >Find Flight</ h3>
                            <img src={stay} className='h-[16px] ml-5' alt="" /><h3 >Find Stay</ h3>
                        </div>
                    </Link>
                    <Link to={'/'}>
                        <div><img src={LOGO} alt="" className='h-[40px] mt-3' /></div>
                    </Link>
                </div>
                    ...
                    !IsLoggedin
                        ...
                        <>
                            <div className='flex gap-[32px] items-center'>
                                ...
                                <Link to={'Signup'}>
                                    <button className='bg-white border rounded-md font-semibold text-[14px] text-black w-[104px] h-[40px] mr-3'>Signup</button>
                                </Link>
                            </div>
                        </>
                        :
