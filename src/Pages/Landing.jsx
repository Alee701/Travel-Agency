    ...
    <>
      ...
      <div className='w-full flex  items-center justify-center'>
        <div className='w-[85%] '>
          ...
          <p className='text-[#112211] text-[16px] font-normal mt-2 opacity-[80%]'>Search Flights & Places Hire to our most popular destinations</p>
        </div>
      </div>
      ...
      <div className='w-[full] flex mt-14 justify-center'>
        ...
        <HotelsLanding></HotelsLanding>
        
      </div>
      <div className='w-[full] flex mt-14 justify-center'>
        <div className='w-[85%] '>

          <h1 className='text-3xl font-semibold ml-4 '>Reviews</h1>
          <p className='mt-3 ml-4'>What people says about Golobe facilities</p>
        </div>
      </div>
      <div className='w-[full] flex mt-14 justify-center'>
