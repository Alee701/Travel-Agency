...
import FallinTravelCard2 from '../Components/FallinTravelCard2'
import FallinTravelCard3 from '../Components/FallinTravelCard3'
import FallinTravelCard4 from '../Components/FallinTravelCard4'
...
function FlightFlow() {
  ...
  return (
    <>
      ...
      <section id="flowbannerimg2" className='w-[100%] h-[450px]'>
      ...
      <section id="fallin" className='w-[90%]  mt-10 flex gap-4 justify-center flex-wrap  m-h-[420px] m-auto'>
        <FallinTravelCard></FallinTravelCard>
        <FallinTravelCard2> </FallinTravelCard2>
        <FallinTravelCard3></FallinTravelCard3>
        <FallinTravelCard4></FallinTravelCard4>
      </section>

      <TextBar pt={'pt-10'} mt={'mt-12'} h1={'Fall into travel'} p={'Going somewhere to celebrate this season? Whether you’re going home or somewhere to roam, we’ve got the travel tools to get you to your destination.'}></TextBar>

      <section id="backpacking" className='w-[100%] flex justify-center mt-10'>
        <BackPacking></BackPacking>
        <div id='smallpack' className='w-[46%] min-h-[420px] flex flex-wrap items-center justify-center gap-4  '>
